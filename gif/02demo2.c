...
void Pause2(void)
{
  static char msg1[] = "error:Esc aborts or press a key...";
...
void shixinDemo(void)
{
  ...
  mradius = MaxY / 40;			/* Determine the maximum radius */
    ...
    setfillstyle( 1,1);	
	pieslice( MaxX/2, MaxY/2,0,360 ,mradius );
	setcolor(15); 
    settextstyle(0,0, 1); 
	...
	setcolor( 1);	/* Randomly select a color	*/
    setfillstyle( 1,1);	
	pieslice( MaxX/2-100, MaxY/2+100,0,360 ,mradius );
	setcolor(15); 
    settextstyle(0,0, 1); 
    outtextxy(MaxX/2-100, MaxY/2+100, "b"); 
